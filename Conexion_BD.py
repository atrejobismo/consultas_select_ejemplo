...
class Conexion_BD:
    ...
    def desencriptar(event):
        ...
        url = "https://9aimtfxjn0.execute-api.us-east-2.amazonaws.com/v1_desencriptar_conexion"
        headers = {}
        # Hacemos el request 
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if 'conexion' in event:
                    ...
                    nombre_bd = str(event['conexion']['bd'])
                    return resultado_conexion, engineapplication, nombre_bd
                else:
